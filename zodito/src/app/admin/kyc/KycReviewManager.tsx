                        ...
                        <div className="flex items-center justify-end gap-2" onClick={e => e.stopPropagation()}>
                          {user.kyc_status === 'pending' && (
                            <>
                              ...
                              <button
                                onClick={() => { setRejectModal({ id: user.id, name: [user.first_name, user.last_name].filter(Boolean).join(' ') || user.email || 'User' }); setRejectReason(''); }}
                          ...
                          <div className="space-y-3">
                            ...
                            {user.kyc_status === 'rejected' && user.kyc_rejection_reason && (
                              <div className="p-3 bg-danger/5 border border-danger/20 rounded-lg">
                                ...
                                <p className="text-sm text-danger/80">{user.kyc_rejection_reason}</p>
                              </div>
                            )}
