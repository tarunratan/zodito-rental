                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center justify-end gap-2" onClick={e => e.stopPropagation()}>
                          {vendor.status === 'pending' && (
                            <>
                              <button
                                onClick={() => review(vendor.id, 'approve')}
                              ...
                              <button
                                onClick={() => { setRejectModal({ id: vendor.id, name: vendor.business_name }); setNotes(''); }}
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-primary rounded-xl shadow-2xl w-full max-w-sm p-5 space-y-4">
            ...
            <textarea
              ...
              placeholder="Feedback for the vendor (optional)"
            />
            <div className="flex justify-end gap-3">
              ...
              <button
                onClick={() => review(rejectModal.id, 'reject', notes)}
